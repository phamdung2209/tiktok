...
import classNames1 from 'classnames/bind';
import styles from './MenuItems.module.scss';

const cx = classNames1.bind(styles)

function MenuItems({ MENU_ITEMS, user, loggedInUserData, currentUser, handleMenuChange }) {
    return (
        <MenuPopper menuItems={MENU_ITEMS} currentUser={currentUser} onChange={handleMenuChange}>
            {user && currentUser ? (
                <Image
